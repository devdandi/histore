...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::post('/categories/featured', 'CategoryController@updateFeatured')->name('categories.featured');
		Route::get('/product/typeunit','TypeUnitController@index')->name('product.unit');
	Route::post('/product/typeunit','TypeUnitController@store')->name('unit.add');
	Route::post('/product/typeunite','TypeUnitController@store_bulk')->name('unit.add.bulk');

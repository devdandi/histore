...
Route::group(['middleware' => ['user', 'verified']], function(){
	...
	Route::get('/purchase_history/details/{order}', 'PurchaseHistoryController@details_order')->name('detailed.order');
...
Route::group(['middleware' => ['auth']], function(){
	Route::get('/qr-code/{order_id}', 'QrCodeController@index')->name('qr-input');
	Route::post('/qr-code', 'QrCodeController@read')->name('qr-read');
	...
	Route::get('invoice/seller/{order_id}', 'InvoiceController@seller_label_download')->name('seller.label.download');
...
Route::get('/track_your_resi', 'HomeController@trackresi')->name('resi.track');
...
Route::post('/addresses/edit', 'AddressController@edit')->name('addresses.edit');

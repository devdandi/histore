...
Route::get('/shop-close', 'HomeController@shop_close')->name('shop.close');
Route::get('/shop-open', 'HomeController@shop_open')->name('shop.open');

Route::post('/selecting', 'SelectingController@dropdown')->name('selecting');

Route::post('/cost','ApiShipmentController@shipping_cost')->name('check.cost');

Route::post('/update-cart','CheckoutController@update_shipping_on_cart')->name('update.carts');
Route::get('/get-cart','CheckoutController@get_shipping_on_cart')->name('get.carts');

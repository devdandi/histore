...
class PurchaseHistoryController extends Controller
{
    ...
    public function details_order($orders)
    {
        $order = OrderDetail::where('order_id', $this->getIdByOrderId($orders))->get();
        return view('frontend.order.index_customer', compact('order','orders'));
    }
    public function getIdByOrderId($order)
    {
        return Order::where('code', $order)->first()->id;
    }
}

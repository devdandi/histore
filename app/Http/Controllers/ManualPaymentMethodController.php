...
class ManualPaymentMethodController extends Controller
{
    ...
    public function submit_offline_payment(Request $request)
    {
        ...
        if($request->name != null && $request->amount != null && $request->trx_id != null && $request->trf_cost != null && $request->trf_code != null && $request->trf_total != null){
            $data['name'] = $request->name;
            $data['amount'] = $request->amount;
            $data['trx_id'] = $request->trx_id;
			$data['trx_code'] = $request->trf_code;
			$data['trx_total'] = $request->trf_total;
            if($request->hasFile('photo')){

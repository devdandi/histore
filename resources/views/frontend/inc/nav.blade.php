        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-5 text-right d-none d-lg-block">
                    ...
                    @if(Auth::id() !== null)
                        <li>
                            <a  class="top-bar-item" href="#">Saldo : Rp. {{ number_format( Auth::user()->balance) }}</a>    
                        </li>
                        @endif
						<li>
                            <a href="{{ route('resi.track') }}" class="top-bar-item">{{ translate('Track Resi')}}</a>
                        </li>
                        ...
                        <li>
                            <a onclick="return confirm(' {{ translate('Are you sure to logout ?') }}')" href="{{ route('logout') }}" class="top-bar-item">{{ translate('Logout')}}</a>
                        </li>
                        @else
                        <li>
                ...
                <div class="side-menu-header ">
                    ...
                    @auth
                        ...
                        <div class="side-login px-3 pb-3">
                            ...
                            @if(Auth::id() !== null)
                                <a href="#">Saldo : Rp. {{ number_format( Auth::user()->balance) }}</a>
                            @endif
                        </div>

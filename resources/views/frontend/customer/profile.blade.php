                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        @php $ex_province = explode("|", $address->province); @endphp
                                                        <span class="strong-600 ml-2">{{ $ex_province[1] }}</span>
                                                    </div>
                                                    <div>
                                                        <span class="alpha-6">{{ translate('City')}}:</span>
                                                        @php $ex_city = explode("|", $address->city); @endphp

                                                        <span class="strong-600 ml-2">{{ $ex_city[1] }} {{ $ex_city[0] }}</span>
                                                    </div>
                                                    <div>
                ...
                <form class="form-default" role="form" action="{{ route('addresses.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-10">
                                    <textarea class="form-control textarea-autogrow mb-3" placeholder="{{ translate('Your Name')}}" rows="1" name="name" required></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control mb-3" placeholder="{{ translate('Your District')}}" name="district" value="" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2">

                                                ...
                                                <label  class="aiz-megabox d-block bg-white">
                                                    ...
                                                    <span class="d-flex p-3 aiz-megabox-elem">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div>
                                                            @php $provinces = explode('|', $address->province); @endphp

                                                                <span class="alpha-6">{{ translate('Province') }}:</span>
                                                                <span class="strong-600 ml-2">{{ $provinces[1] }}</span>
                                                            </div>

                                                            <div>
                                                            @php $city = explode('|', $address->city); @endphp
                                                                <span class="alpha-6">{{ translate('City') }}:</span>
                                                                <span class="strong-600 ml-2">{{ $city[1] }} {{ $city[0] }}</span>
                                                            </div>
                                                            <div>
            ...
            <form class="form-default" role="form" action="{{ route('addresses.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="p-3">
                        <div class="row">
                            <div class="col-md-2">
                                <label>{{ translate('Recipient name')}}</label>
                            </div>
                            <div class="col-md-10">
                                <input class="form-control textarea-autogrow mb-3" placeholder="{{ translate('Recipient name')}}" rows="1" name="name" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    <select class="form-control mb-3 selectpicker" data-placeholder="{{ translate('Select your province')}}" name="province" required>
                                        @foreach(DB::table('province_ruangapi')->get() as $province)
                                            <option value="">{{ translate('Select your province') }}</option>
                                            <option value="{{ $province->province_id }}|{{$province->name}}">{{$province->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                            <div class="mb-3">
                                    <select class="form-control mb-3 selectpicker" data-placeholder="{{ translate('Select your city')}}" name="city" id="city" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control textarea-autogrow mb-3" placeholder="{{ translate('Your District')}}" name="district" required>
                            </div>
                        </div> 
                        <div class="row">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-10">
                            <div class="mb-3">
                                <input type="number" min="0" class="form-control mb-3" placeholder="{{ translate('Postal code')}}" name="postal_code" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input type="number" min="0" class="form-control mb-3" placeholder="{{ translate('+880')}}" name="phone" value="" required>
                            </div>
                        </div>
                    </div>
                </div>

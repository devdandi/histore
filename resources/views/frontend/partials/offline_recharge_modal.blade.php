        ...
        <div id="manual_payment_data">
            ...
            <div class="card mb-3 p-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="number" class="form-control mb-3" min="50000" name="amount" id="amount" placeholder="{{ translate('Minimal 50.000 dan kelipatan 10.000') }}" required>
                    </div>
                </div>
				<div class="row">
                    <div class="col-md-3">
                        <label>{{ translate('Payment screenshot')}} </label>
                    </div>
                    <div class="col-md-9">
				...
				<div class="row">
                    <div class="col-md-3">
                        <label>{{ translate('Transaction Code')}} </label>
                    </div>
                    <div class="col-md-9">
				...
				<div class="row">
                    <div class="col-md-3">
                        <label>{{ translate('Total Transfer')}} </label>
                    </div>
                    <div class="col-md-9">
      ...
      @if ($method->bank_info != null)
          <ul>
              @foreach (json_decode($method->bank_info) as $key => $info)
				  ...
				  <li>Account Name - {{ $info->account_name }}

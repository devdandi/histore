        ...
        <div class="card-body">
            ...
            <tfoot>
                <tr class="cart-subtotal">
                    ...
                    <td class="text-right">
                        <span class="strong-600">{{ strtoupper($data->logistics) }} {{ $data->service }}</span>
                    </td>
                </tr>
                ...
                <tr class="cart-shipping">
                    ...
                    <td class="text-right">
                        <span class="text-italic">{{ single_price($data->shipping_cost) }}</span>
                    </td>
                </tr>
                <tr class="cart-shipping">
                    <th>{{translate('Receipt')}}</th>
                    <td class="text-right">
                        <span class="text-italic">{{ $data->receipt }}</span>
                    </td>
                </tr>
            </tfoot>
        </table>
        ...
        <div class="col-md-4">
            ...
            <tfoot>
                <tr class="cart-subtotal">
                    <th>{{translate('Shipping Cost')}}</th>
                    <td class="text-right">
                        <span class="strong-600">{{ single_price($shipping_cost) }}</span>
                    </td>
                </tr>

                <tr class="cart-shipping">
                    <th>{{translate('Order Ammount')}}</th>
                    <td class="text-right">
                        <span class="text-italic">{{ single_price($subtotal) }}</span>
                    </td>
                </tr>

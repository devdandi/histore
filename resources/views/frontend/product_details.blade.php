                        ...
                        <div class="product-description-wrapper">
                            ...
                            <div class="d-table width-100 mt-3">
                                <div class="d-table-cell">
                                    <!-- Buy Now button -->
                                    @if ($qty > 0 && $detailedProduct->user->status == "active")
                                    ...
                                    @elseif($detailedProduct->user->status == "close")
                                        <button type="button" class="btn btn-styled btn-base-3 btn-icon-left strong-700" disabled>
                                            <i class="la la-cart-arrow-down"></i> {{ translate('This shop is closed')}}
                                        </button>
                                        @elseif($qty < 1)
                                        <button type="button" class="btn btn-styled btn-base-3 btn-icon-left strong-700" disabled>
                            ...
                            @if ($refund_request_addon != null && $refund_request_addon->activated == 1 && $detailedProduct->refundable)
                                <div class="row no-gutters mt-3">
                                    ...
                                    <div class="col-10">
                                        <a href="{{ route('returnpolicy') }}" target="_blank"> @if ($refund_sticker != null && $refund_sticker->value != null) <img src="{{ my_asset($refund_sticker->value) }}" height="36"> @else <img src="{{ my_asset('frontend/images/refundsticker.jpg') }}" height="36"> @endif</a>

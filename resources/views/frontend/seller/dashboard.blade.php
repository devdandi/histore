            ...
            <div class="row cols-xs-space cols-sm-space cols-md-space">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="alert alert-warning" role="alert">
                        {{ translate('Your shop is close, you have to click the button open on the bottom so that receive transaction again !')}}
                    </div>
                    @endif
                    ...
                    <div class="">
                            ...
                            <div class="col-md-3 col-6">
                                <div class="dashboard-widget text-center red-widget mt-4 c-pointer">
                                    <a href="javascript:;" class="d-block">
                                        ...
                                        <span class="d-block sub-title">{{ translate('Pending Orders')}}</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="bg-white mt-4 p-4 text-center">
                                    <div class="heading-4 strong-700">{{ translate('Close Shop')}}</div>
                                    <p>{{ translate("You've never received any transaction till you open the shop again !")}}</p>
                                    <a href="{{ route('shop.close') }}" class="btn btn-styled btn-base-1 btn-outline btn-sm">{{ translate('Close')}}</a>
                                </div>
                                @else
                                <div class="bg-white mt-4 p-4 text-center">
                                    <div class="heading-4 strong-700">{{ translate('Open Shop')}}</div>
                                    <p>{{ translate("You'll received transaction again !")}}</p>
                                    <a href="{{ route('shop.open') }}" class="btn btn-styled btn-base-1 btn-outline btn-sm">{{ translate('Open')}}</a>
                                </div>
                                @endif
                                <div class="bg-white mt-4 p-4 text-center">

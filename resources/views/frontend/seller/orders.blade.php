                                        ...
                                        @foreach ($orders as $key => $order_id)
                                            ...
                                            @if($order != null)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($datas = $order->orderDetails->where('seller_id', Auth::id())->first()->receipt != null)
                                                            {{$order->orderDetails->where('seller_id', Auth::id())->first()->receipt }}
                                                            @else
                                                            Null
                                                        @endif
                                                    </td>
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="">
                                                                ...
                                                                <a href="{{ route('seller.label.download', $order->id, ) }}" class="dropdown-item">{{ translate('Download Label Shipping')}}</a>
                                                                <a href="{{ route('qr-input', $order->code) }}" class="dropdown-item">{{ translate('Input receipt')}}</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>

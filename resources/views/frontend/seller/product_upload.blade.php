                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <!-- <input type="text" class="form-control mb-3" name="unit" placeholder="{{ translate('Product unit') }}" required> -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" class="form-control mb-3" name="long_product" value="0" min="1" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" class="form-control mb-3" name="high" value="0" min="1" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" class="form-control mb-3" name="wide" value="0" min="1" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" class="form-control mb-3" name="weight" value="0" min="1" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">

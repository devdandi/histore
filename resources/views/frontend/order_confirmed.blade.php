                                            ...
                                            <tbody>
                                                @foreach ($order->orderDetails as $key => $orderDetail)
                                                    <tr>
                                                        ...
                                                        <td>{{ strtoupper($orderDetail->logistics) }}</td>
                                                        <td>{{ strtoupper($orderDetail->service) }}</td>
                                                        <td>{{ strtoupper($orderDetail->shipping_cost) }}</td>
                                        ...
                                        <div class="col-xl-5 col-md-6 ml-auto">
                                            <table class="table details-table">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th><span class="strong-600">{{ translate('Subtotal')}}</span></th>
                                                        <td class="text-right">

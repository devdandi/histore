...
<h3 class="text-center"><?php echo e(translate('HTTPS Activation')); ?></h3>
<div class="row">
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('HTTPS Activation')); ?></h3>
            </div>
...
<h3 class="text-center"><?php echo e(translate('Maintenance Mode')); ?></h3>
<div class="row">
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('Maintenance Mode Activation')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <label class="switch">
...
<div class="row">
    <h3 class="text-center"><?php echo e(translate('Classified Product Activate')); ?></h3>
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('Classified Product')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <label class="switch">
...
<h3 class="text-center"><?php echo e(translate('Business Related')); ?></h3>
<div class="row">
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('Vendor System Activation')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <label class="switch">
    ...
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('Wallet System Activation')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <label class="switch">
    ...
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('Coupon System Activation')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <label class="switch">
...
<div class="row">
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('Pickup Point Activation')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <label class="switch">
    ...
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('Conversation Activation')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <label class="switch">
    ...
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('Guest Checkout Activation')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <label class="switch">
...
<div class="row">
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('Category-based Commission')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <label class="switch">
                ...
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    <?php echo e(translate('After activate this option Seller commision will be disabled and You need to set commission on each category otherwise Admin will not get any commision')); ?>. <a href="<?php echo e(route('categories.index')); ?>"><?php echo e(translate('Set Commisssion Now')); ?></a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('Email Verification')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <label class="switch">
...
<h3 class="text-center"><?php echo e(translate('Payment Related')); ?></h3>
<div class="row">
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading text-center bord-btm">
                <h3 class="panel-title"><?php echo e(translate('Paypal Payment Activation')); ?></h3>
            </div>
            <div class="panel-body">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="<?php echo e(my_asset('frontend/images/icons/cards/paypal.png')); ?>" height="30">
    ...
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('Stripe Payment Activation')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="<?php echo e(my_asset('frontend/images/icons/cards/stripe.png')); ?>" height="30">
                    <label class="switch pull-right">
    ...
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('SSlCommerz Activation')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="<?php echo e(my_asset('frontend/images/icons/cards/sslcommerz.png')); ?>" height="30">
                    <label class="switch pull-right">
...
<div class="row">
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('Instamojo Payment Activation')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="<?php echo e(my_asset('frontend/images/icons/cards/instamojo.png')); ?>" height="30">
                    <label class="switch pull-right">
    ...
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('Razor Pay Activation')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="<?php echo e(my_asset('frontend/images/icons/cards/rozarpay.png')); ?>" height="30">
                    <label class="switch pull-right">
    ...
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('PayStack Activation')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="<?php echo e(my_asset('frontend/images/icons/cards/paystack.png')); ?>" height="30">
                    <label class="switch pull-right">
...
<div class="row">
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('VoguePay Activation')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="<?php echo e(my_asset('frontend/images/icons/cards/vogue.png')); ?>" height="30">
                    <label class="switch pull-right">
    ...
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('Payhere Activation')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="<?php echo e(my_asset('frontend/images/icons/cards/payhere.png')); ?>" height="30">
                    <label class="switch pull-right">
    ...
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('Cash Payment Activation')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="<?php echo e(my_asset('frontend/images/icons/cards/cod.png')); ?>" height="30">
                    <label class="switch pull-right">
...
<div class="row">
    <h3 class="text-center"><?php echo e(translate('Social Media Login')); ?></h3>
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('Facebook login')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <label class="switch">
    ...
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('Google login')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <label class="switch">
    ...
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(translate('Twitter login')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <label class="switch">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u9037400/public_html/hs/resources/views/business_settings/activation.blade.php ENDPATH**/ ?>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6 col-12">
                                    <h2 class="heading heading-6 text-capitalize strong-600 mb-0">
                                        <?php echo e(translate('Purchase History')); ?>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active"><a href="<?php echo e(route('purchase_history.index')); ?>"><?php echo e(translate('Purchase History')); ?></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(count($order->orderDetails) > 0): ?>
                                                    <tr>
                                                        <td>
                                                            <a href="<?php echo e(route('detailed.order', $order->code)); ?>"><?php echo e($order->code); ?></a>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <?php echo e(ucfirst(str_replace('_', ' ', $order->orderDetails->first()->delivery_status))); ?>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="">
                                                                    <!-- <button onclick="show_purchase_history_details(<?php echo e($order->id); ?>)" class="dropdown-item"><?php echo e(translate('Order Details')); ?></button> -->
                                                                    <a href="<?php echo e(route('detailed.order', $order->code)); ?>" class="dropdown-item"><?php echo e(translate('Order detail')); ?></a>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom product-modal" id="modal-size" role="document">
            <div class="modal-content position-relative">
                <div class="modal-header">
                    <h5 class="modal-title strong-600 heading-5"><?php echo e(translate('Make Payment')); ?></h5>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\updatehs\resources\views/frontend/purchase_history.blade.php ENDPATH**/ ?>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active"><a href="<?php echo e(route('payments.index')); ?>"><?php echo e(translate('Payment History')); ?></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u9037400/public_html/hs/resources/views/frontend/seller/payment_history.blade.php ENDPATH**/ ?>
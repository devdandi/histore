<?php if(count($product_ids) > 0): ?>
    <label class="col-sm-3 control-label"><?php echo e(translate('Discounts')); ?></label>
    <div class="col-sm-9">
        <table class="table table-bordered">
    		<thead>
    			<tr>
    				<td class="text-center" width="40%">
    					<label for="" class="control-label"><?php echo e(translate('Product')); ?></label>
    				</td>
                    <td class="text-center">
    					<label for="" class="control-label"><?php echo e(translate('Base Price')); ?></label>
    				</td>
    				<td class="text-center">
    					<label for="" class="control-label"><?php echo e(translate('Discount')); ?></label>
    				</td>
                    <td>
                        <label for="" class="control-label"><?php echo e(translate('Discount Type')); ?></label>
                    </td>
    			</tr>
    		</thead>
    		<tbody>
...
<?php endif; ?>
<?php /**PATH /home/u9037400/public_html/hs/resources/views/partials/flash_deal_discount_edit.blade.php ENDPATH**/ ?>
                    ...
                    <div class="form-default bg-white p-4">
                                ...
                                <table class="table-cart border-bottom">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="product-price d-none d-lg-table-cell"><?php echo e(translate('Price')); ?></th>
                                            <th class="product-quanity d-none d-md-table-cell"><?php echo e(translate('Quantity')); ?></th>
                                            <th class="product-total"><?php echo e(translate('Total')); ?></th>
                                        ...
                                        <?php $__currentLoopData = Session::get('cart'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cartItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr class="cart-item">
                                                <td class="product-image">
                                                    <a href="#" class="mr-3">
                                                        <img loading="lazy"  src="<?php echo e(my_asset($product->thumbnail_img)); ?>">
                                                    </a>
                                                </td>
                        ...
                        <div class="row align-items-center pt-4">
                            ...
                            <div class="col-md-6 text-right">
                                <?php if(Auth::check()): ?>
                                    <a href="<?php echo e(route('checkout.shipping_info')); ?>" class="btn btn-styled btn-base-1"><?php echo e(translate('Continue to Shipping')); ?></a>
                                <?php else: ?>
                                    <button class="btn btn-styled btn-base-1" onclick="showCheckoutModal()"><?php echo e(translate('Continue to Shipping')); ?></button>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                        ...
                        <form class="form-default" role="form" action="<?php echo e(route('cart.login.submit')); ?>" method="POST">
                            ...
                            <div class="form-group">
                                <div class="input-group input-group--style-1">
                                    <input type="email" name="email" class="form-control" placeholder="<?php echo e(translate('Email or Phone')); ?>">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <a href="<?php echo e(route('password.request')); ?>" class="link link-xs link--style-3"><?php echo e(translate('Forgot password?')); ?></a>
                                </div>
                                <div class="col-md-6 text-right">
                    ...
                    <?php if(\App\BusinessSetting::where('type', 'guest_checkout_active')->first()->value == 1): ?>
                        ...
                        <div class="text-center">
                            <a href="<?php echo e(route('checkout.shipping_info')); ?>" class="btn btn-styled btn-base-1"><?php echo e(translate('Guest Checkout')); ?></a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u9037400/public_html/hs/resources/views/frontend/view_cart.blade.php ENDPATH**/ ?>
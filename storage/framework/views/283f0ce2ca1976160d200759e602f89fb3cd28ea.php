...
<?php $__env->startSection('content'); ?>
    ...
    <div class="tab-base">
        ...
        <ul class="nav nav-tabs">
            <li class="active">
                <a data-toggle="tab" href="#demo-lft-tab-1" aria-expanded="true"><?php echo e(translate('Home slider')); ?></a>
            </li>
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-2" aria-expanded="false"><?php echo e(translate('Home banner 1')); ?></a>
            </li>
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-4" aria-expanded="false"><?php echo e(translate('Home categories')); ?></a>
            </li>
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-3" aria-expanded="false"><?php echo e(translate('Home banner 2')); ?></a>
            </li>
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-5" aria-expanded="false"><?php echo e(translate('Top 10')); ?></a>
            </li>
        </ul>
        ...
        <div class="tab-content">
            <div id="demo-lft-tab-1" class="tab-pane fade active in">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <a onclick="add_slider()" class="btn btn-rounded btn-info pull-right"><?php echo e(translate('Add New Slider')); ?></a>
                    </div>
                </div>
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?php echo e(translate('Home slider')); ?></h3>
                    </div>
                        ...
                        <table class="table table-striped table-bordered demo-dt-basic" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th width="50%"><?php echo e(translate('Link')); ?></th>
                            ...
                            <tbody>
                                <?php $__currentLoopData = \App\Slider::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><img loading="lazy"  class="img-md" src="<?php echo e(my_asset($slider->photo)); ?>" alt="Slider Image"></td>
                                        ...
                                        <td>
                                            <div class="btn-group dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a onclick="confirm_modal('<?php echo e(route('sliders.destroy', $slider->id)); ?>');"><?php echo e(translate('Delete')); ?></a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
            ...
            <div id="demo-lft-tab-2" class="tab-pane fade">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <a onclick="add_banner_1()" class="btn btn-rounded btn-info pull-right"><?php echo e(translate('Add New Banner')); ?></a>
                    </div>
                </div>
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?php echo e(translate('Home banner')); ?> (<?php echo e(translate('Max 3 published')); ?>)</h3>
                    </div>
                    <div class="panel-body">
                        <table class="table table-striped table-bordered demo-dt-basic" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th><?php echo e(translate('Photo')); ?></th>
                                    <th><?php echo e(translate('Position')); ?></th>
                                    <th><?php echo e(translate('Published')); ?></th>
                                    <th width="10%"><?php echo e(translate('Options')); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $__currentLoopData = \App\Banner::where('position', 1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($key+1); ?></td>
                                        <td><img loading="lazy"  class="img-md" src="<?php echo e(my_asset($banner->photo)); ?>" alt="banner Image"></td>
                                        <td><?php echo e(translate('Banner Position ')); ?><?php echo e($banner->position); ?></td>
                                        <td><label class="switch">
                                        ...
                                        <td>
                                            <div class="btn-group dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a onclick="edit_home_banner_1(<?php echo e($banner->id); ?>)"><?php echo e(translate('Edit')); ?></a></li>
                                                    <li><a onclick="confirm_modal('<?php echo e(route('home_banners.destroy', $banner->id)); ?>');"><?php echo e(translate('Delete')); ?></a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
            ...
            <div id="demo-lft-tab-3" class="tab-pane fade">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <a onclick="add_banner_2()" class="btn btn-rounded btn-info pull-right"><?php echo e(translate('Add New Banner')); ?></a>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a onclick="edit_home_banner_2(<?php echo e($banner->id); ?>)"><?php echo e(translate('Edit')); ?></a></li>
                                                    <li><a onclick="confirm_modal('<?php echo e(route('home_banners.destroy', $banner->id)); ?>');"><?php echo e(translate('Delete')); ?></a></li>
                                                </ul>
                                            </div>
                                        </td>
            ...
            <div id="demo-lft-tab-4" class="tab-pane fade">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <a onclick="add_home_category()" class="btn btn-rounded btn-info pull-right"><?php echo e(translate('Add New Category')); ?></a>
                    </div>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        <li><a onclick="edit_home_category(<?php echo e($home_category->id); ?>)"><?php echo e(translate('Edit')); ?></a></li>
                                                        <li><a onclick="confirm_modal('<?php echo e(route('home_categories.destroy', $home_category->id)); ?>');"><?php echo e(translate('Delete')); ?></a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
            ...
            <div id="demo-lft-tab-5" class="tab-pane fade">
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?php echo e(translate('Top 10 Information')); ?></h3>
                    </div>
                    ...
                    <form class="form-horizontal" action="<?php echo e(route('top_10_settings.store')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <label class="col-sm-3" for="url"><?php echo e(translate('Top Categories (Max 10)')); ?></label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3" for="url"><?php echo e(translate('Top Brands (Max 10)')); ?></label>
                                <div class="col-sm-9">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u9037400/public_html/hs/resources/views/home_settings/index.blade.php ENDPATH**/ ?>
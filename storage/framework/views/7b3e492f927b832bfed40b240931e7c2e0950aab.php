	...
	<table class="table table-bordered">
		<thead>
			<tr>
				...
				<td class="text-center">
					<label for="" class="control-label"><?php echo e(translate('Variant Price')); ?></label>
				</td>
				<td class="text-center">
...
<?php endif; ?>
<?php /**PATH /home/u9037400/public_html/hs/resources/views/partials/sku_combinations_edit.blade.php ENDPATH**/ ?>
                        ...
                        <form class="form-default" data-toggle="validator" action="<?php echo e(route('checkout.store_delivery_info')); ?>" role="form" method="POST">
                                                    ...
                                                    <tr class="cart-item">
                                                        <td class="product-image" width="25%">
                                                            <a href="<?php echo e(route('product', \App\Product::find($id)->slug)); ?>" target="_blank">
                                                                <img loading="lazy"  src="<?php echo e(my_asset(\App\Product::find($id)->thumbnail_img)); ?>">
                                                            </a>
                                                        </td>
                                        ...
                                        <div class="col-md-6">
                                                ...
                                                <?php if(\App\BusinessSetting::where('type', 'pickup_point')->first()->value == 1): ?>
                                                    <div class="col-6">
                                                        <label class="d-flex align-items-center p-3 border rounded gry-bg c-pointer">
                                                            ...
                                                            <span class="radio-box"></span>
                                                            <span class="d-block ml-2 strong-600">
                                                                <?php echo e(translate('Local Pickup')); ?>
                                            ...
                                            <?php if(\App\BusinessSetting::where('type', 'pickup_point')->first()->value == 1): ?>
                                                <div class="mt-3 pickup_point_id_admin d-none">
                                                    <select class="pickup-select form-control-lg w-100" name="pickup_point_id_admin" data-placeholder="<?php echo e(translate('Select a pickup point')); ?>">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <span>Pilih Pengiriman</span>
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <select id="logistics" name="shipping_type[]" onclick="show_pickup_point(this)" class="form-control" >
                                                        ...
                                                        <?php if(\App\BusinessSetting::where('type', 'pickup_point')->first()->value == 1): ?>
                                                            <?php if(is_array(json_decode(\App\Shop::where('user_id', $key)->first()->pick_up_point_id))): ?>
                                                                <div class="col-6">
                                                                    <label class="d-flex align-items-center p-3 border rounded gry-bg c-pointer">
                                                                        <input type="radio" name="shipping_type[]" value="pickup_point" class="d-none" onchange="show_pickup_point(this)" data-target=".pickup_point_id_<?php echo e($key); ?>">
                                                                        <span class="radio-box"></span>
                                                                        <span class="d-block ml-2 strong-600">
                                                                            <?php echo e(translate('Local Pickup')); ?>
                                                    ...
                                                    <?php if(\App\BusinessSetting::where('type', 'pickup_point')->first()->value == 1): ?>
                                                        <?php if(is_array(json_decode(\App\Shop::where('user_id', $key)->first()->pick_up_point_id))): ?>
                                                            <div class="mt-3 pickup_point_id_<?php echo e($key); ?> d-none">
                                                                <select class="pickup-select form-control-lg w-100" name="pickup_point_id_<?php echo e($key); ?>" data-placeholder="<?php echo e(translate('Select a pickup point')); ?>">
                                                                    <option><?php echo e(translate('Select your nearest pickup point')); ?></option>
                            ...
                            <div class="row align-items-center pt-4">
                                ...
                                <div class="col-md-6 text-right">
                                    <button id="btns" type="submit" class="btn btn-styled btn-base-1"><?php echo e(translate('Continue to Payment')); ?></a>
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        // $('#service-logistics').css('display','none')
        function show_pickup_point(el) {
        	var value = $(el).val();
            var target = $(el).data('target');
            $.ajax({
                url: "<?php echo e(route('check.cost')); ?>",
                type: "POST",
                data: {
                ...
                success: function(data)
                {
                    $.each(data.costs, function(i, item){
                        $.each(item.cost, function(j, costs){
                            $(el).append(`<option value="`+data.code+`|`+item.service+`|`+costs.value+`">`+item.service+` (Rp. `+ costs.value+`)</option>`)
                        })
                    })
                }
            })
    }
    function sent_courier(el)
    {
        var value = $(el).val()
        
        $.ajax({
            url: "<?php echo e(route('update.carts')); ?>",
            type: "POST",
            data: {
                _token: "<?php echo e(csrf_token()); ?>",
                data: value
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u9037400/public_html/hs/resources/views/frontend/delivery_info.blade.php ENDPATH**/ ?>
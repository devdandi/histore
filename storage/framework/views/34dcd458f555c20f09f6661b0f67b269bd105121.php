                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6 col-12">
                                    <h2 class="heading heading-6 text-capitalize strong-600 mb-0">
                                        <?php echo e(translate('Download Your Product')); ?>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active"><a href="<?php echo e(route('digital_purchase_history.index')); ?>"><?php echo e(translate('Download')); ?></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $order_id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="btn btn-styled btn-base-1" href="<?php echo e(route('digitalproducts.download', encrypt($order->product->id))); ?>"><?php echo e(translate('Download')); ?></a></td>
                                            </tr>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u9037400/public_html/hs/resources/views/frontend/digital_purchase_history.blade.php ENDPATH**/ ?>
                                ...
                                <div class="col-md-6">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li><a href="<?php echo e(route('conversations.index')); ?>"><?php echo e(translate('Conversations')); ?></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="col-1">
                                                <div class="block-image">
                                                    <?php if(Auth::user()->id == $conversation->sender_id): ?>
                                                        <img <?php if($conversation->receiver->avatar_original == null): ?> src="<?php echo e(my_asset('frontend/images/user.png')); ?>" <?php else: ?> src="<?php echo e(my_asset($conversation->receiver->avatar_original)); ?>" <?php endif; ?> class="rounded-circle">
                                                    <?php else: ?>
                                                        <img <?php if($conversation->sender->avatar_original == null): ?> src="<?php echo e(my_asset('frontend/images/user.png')); ?>" <?php else: ?> src="<?php echo e(my_asset($conversation->sender->avatar_original)); ?>" <?php endif; ?> class="rounded-circle">
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="col-2">
                                                            ...
                                                            <div class="col">
                                                                <h4 class="heading heading-6">
                                                                    ...
                                                                    <?php if((Auth::user()->id == $conversation->sender_id && $conversation->sender_viewed == 0) || (Auth::user()->id == $conversation->receiver_id && $conversation->receiver_viewed == 0)): ?>
                                                                        <span class="badge badge-pill badge-danger"><?php echo e(translate('New')); ?></span>
                                                                    <?php endif; ?>
                                                                </h4>
                                                            </div>
                                                        </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u9037400/public_html/hs/resources/views/frontend/conversations/index.blade.php ENDPATH**/ ?>
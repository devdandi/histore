                    ...
                    <div class="col-lg-8">
                        <form action="<?php echo e(route('payment.checkout')); ?>" class="form-default" data-toggle="validator" role="form" method="POST" id="checkout-form">
                                                ...
                                                <?php if(\App\BusinessSetting::where('type', 'paypal_payment')->first()->value == 1): ?>
                                                    <div class="col-6">
                                                        <label class="payment_option mb-4" data-toggle="tooltip" data-title="Paypal">
                                                            ...
                                                            <span>
                                                                <img loading="lazy"  src="<?php echo e(my_asset('frontend/images/icons/cards/paypal.png')); ?>" class="img-fluid">
                                                            </span>
                                                        </label>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if(\App\BusinessSetting::where('type', 'stripe_payment')->first()->value == 1): ?>
                                                    <div class="col-6">
                                                        <label class="payment_option mb-4" data-toggle="tooltip" data-title="Stripe">
                                                            ...
                                                            <span>
                                                                <img loading="lazy"  src="<?php echo e(my_asset('frontend/images/icons/cards/stripe.png')); ?>" class="img-fluid">
                                                            </span>
                                                        </label>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if(\App\BusinessSetting::where('type', 'sslcommerz_payment')->first()->value == 1): ?>
                                                    <div class="col-6">
                                                        <label class="payment_option mb-4" data-toggle="tooltip" data-title="sslcommerz">
                                                            ...
                                                            <span>
                                                                <img loading="lazy"  src="<?php echo e(my_asset('frontend/images/icons/cards/sslcommerz.png')); ?>" class="img-fluid">
                                                            </span>
                                                        </label>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if(\App\BusinessSetting::where('type', 'instamojo_payment')->first()->value == 1): ?>
                                                    <div class="col-6">
                                                        <label class="payment_option mb-4" data-toggle="tooltip" data-title="Instamojo">
                                                            ...
                                                            <span>
                                                                <img loading="lazy"  src="<?php echo e(my_asset('frontend/images/icons/cards/instamojo.png')); ?>" class="img-fluid">
                                                            </span>
                                                        </label>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if(\App\BusinessSetting::where('type', 'razorpay')->first()->value == 1): ?>
                                                    <div class="col-6">
                                                        <label class="payment_option mb-4" data-toggle="tooltip" data-title="Razorpay">
                                                            ...
                                                            <span>
                                                                <img loading="lazy"  src="<?php echo e(my_asset('frontend/images/icons/cards/rozarpay.png')); ?>" class="img-fluid">
                                                            </span>
                                                        </label>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if(\App\BusinessSetting::where('type', 'paystack')->first()->value == 1): ?>
                                                    <div class="col-6">
                                                        <label class="payment_option mb-4" data-toggle="tooltip" data-title="Paystack">
                                                            ...
                                                            <span>
                                                                <img loading="lazy"  src="<?php echo e(my_asset('frontend/images/icons/cards/paystack.png')); ?>" class="img-fluid">
                                                            </span>
                                                        </label>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if(\App\BusinessSetting::where('type', 'voguepay')->first()->value == 1): ?>
                                                    <div class="col-6">
                                                        <label class="payment_option mb-4" data-toggle="tooltip" data-title="VoguePay">
                                                            ...
                                                            <span>
                                                                <img loading="lazy"  src="<?php echo e(my_asset('frontend/images/icons/cards/vogue.png')); ?>" class="img-fluid">
                                                            </span>
                                                        </label>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if(\App\BusinessSetting::where('type', 'payhere')->first()->value == 1): ?>
                                                   <div class="col-6">
                                                       <label class="payment_option mb-4" data-toggle="tooltip" data-title="payhere">
                                                           ...
                                                           <span>
                                                               <img loading="lazy"  src="<?php echo e(my_asset('frontend/images/icons/cards/payhere.png')); ?>" class="img-fluid">
                                                           </span>
                                                       </label>
                                                   </div>
                                               <?php endif; ?>
                                                <?php if(\App\Addon::where('unique_identifier', 'paytm')->first() != null && \App\Addon::where('unique_identifier', 'paytm')->first()->activated): ?>
                                                    <div class="col-6">
                                                        <label class="payment_option mb-4" data-toggle="tooltip" data-title="Paytm">
                                                            ...
                                                            <span>
                                                                <img loading="lazy" src="<?php echo e(my_asset('frontend/images/icons/cards/paytm.jpg')); ?>" class="img-fluid">
                                                            </span>
                                                        </label>
                                                    </div>
                                                <?php endif; ?>
                                                    ...
                                                    <?php if($digital != 1): ?>
                                                        <div class="col-6">
                                                            <label class="payment_option mb-4" data-toggle="tooltip" data-title="Cash on Delivery">
                                                                ...
                                                                <span>
                                                                    <img loading="lazy"  src="<?php echo e(my_asset('frontend/images/icons/cards/cod.png')); ?>" class="img-fluid">
                                                                </span>
                                                            </label>
                                                        </div>
                                                    <?php endif; ?>
												...
												<?php if(\App\BusinessSetting::where('type', 'wallet_system')->first()->value == 1): ?>
                                                    ...
                                                    <?php if($digital != 1): ?>
                                                        <div class="col-6">
                                                            <label class="payment_option mb-4" data-toggle="tooltip" data-title="Wallet">
                                                                <input type="radio" id="" name="payment_option" value="wallet" checked>
                                                                <span>
                                                                    <img loading="lazy"  src="<?php echo e(my_asset('frontend/images/icons/cards/wallet.png')); ?>" class="img-fluid">
                                                                </span>
                                                            </label>
                                                        </div>
                                                    <?php endif; ?>
                                        ...
                                        <div class="row">
                                            <div class="col-xxl-6 col-lg-8 col-md-10 mx-auto">
                                                <div class="text-center bg-gray py-4">
                                                    <i class="fa"></i>
                                                    <div class="h5 mb-4"><?php echo e(translate('Your wallet balance :')); ?> <strong><?php echo e(single_price(Auth::user()->balance)); ?></strong></div>
                                                    
													<?php if(Auth::user()->balance < $total): ?>
                                                        <button type="button" class="btn btn-base-2" disabled><?php echo e(translate('Insufficient balance')); ?></button>
                                                    <?php else: ?>
                                                        <button  type="button" onclick="use_wallet()" class="btn btn-base-1"><?php echo e(translate('Pay with wallet')); ?></button>
                                                    <?php endif; ?>
                            ...
                            <div class="pt-3">
                                ...
                                <label for="agree_checkbox"><?php echo e(translate('I agree to the')); ?></label>
    ...
    <script type="text/javascript">
        function use_wallet(){
            ...
            if($('#agree_checkbox').is(":checked")){
                ...
                showFrontendAlert('error','<?php echo e(translate('You need to agree with our policies')); ?>');
            }
        }
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u9037400/public_html/hs/resources/views/frontend/payment_select.blade.php ENDPATH**/ ?>
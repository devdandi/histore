                        ...
                        <form class="" action="<?php echo e(route('orders.track')); ?>" method="GET" enctype="multipart/form-data">
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label><?php echo e(translate('Order Code')); ?> <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                            ...
                            <div class="text-right mt-4">
                                <button type="submit" class="btn btn-styled btn-base-1"><?php echo e(translate('Track Order')); ?></button>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <table class="details-table table">
                                    ...
                                    <tr>
                                        <td class="w-50 strong-600"><?php echo e(translate('Shipping method')); ?>:</td>
                        ...
                        <div class="card-header py-2 px-3 heading-6 strong-600 clearfix">
                            <ul class="process-steps clearfix">
                                <li <?php if($status == 'pending'): ?> class="active" <?php else: ?> class="done" <?php endif; ?>>
                                    <div class="icon"><?php echo e(translate('1')); ?></div>
                            ...
                            <div class="col-6">
                                <table class="details-table table">
                                    <?php if($orderDetail->product != null): ?>
                                        <tr>
                                            <td class="w-50 strong-600"><?php echo e(translate('Product Name')); ?>:</td>
                                            <td><?php echo e($orderDetail->product->name); ?> (<?php echo e($orderDetail->variation); ?>)</td>
                                        </tr>
                                        <tr>
                                            <td class="w-50 strong-600"><?php echo e(translate('Quantity')); ?>:</td>
                                            <td><?php echo e($orderDetail->quantity); ?></td>
                                        </tr>
                                        <tr>
                                            <td class="w-50 strong-600"><?php echo e(translate('Shipped By')); ?>:</td>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u9037400/public_html/hs/resources/views/frontend/track_order.blade.php ENDPATH**/ ?>
        ...
        <form class="form-horizontal" action="<?php echo e(route('policies.store')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <label class="col-sm-2 control-label" for="name"><?php echo e(translate('Content')); ?></label>
                    <div class="col-sm-10">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u9037400/public_html/hs/resources/views/policies/index.blade.php ENDPATH**/ ?>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active"><a href="<?php echo e(route('wishlists.index')); ?>"><?php echo e(translate('Wishlist')); ?></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card card-product mb-3 product-card-2">
                                            <div class="card-body p-3">
                                                <div class="card-image">
                                                    <a href="<?php echo e(route('product', $wishlist->product->slug)); ?>" class="d-block" style="background-image:url('<?php echo e(my_asset($wishlist->product->thumbnail_img)); ?>');">
                                                    </a>
                                                </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u9037400/public_html/hs/resources/views/frontend/view_wishlist.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="col-lg-6">
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title text-center"><?php echo e(translate('Default Language')); ?></h3>
                </div>
                <div class="panel-body">
                    <form class="form-horizontal" action="<?php echo e(route('env_key_update.update')); ?>" method="POST">
                        ...
                        <div class="form-group">
                            <div class="col-lg-3">
                                <label class="control-label"><?php echo e(translate('Default Language')); ?></label>
                            </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <a href="<?php echo e(route('languages.create')); ?>" class="btn btn-rounded btn-info pull-right"><?php echo e(translate('Add New Language')); ?></a>
        </div>
    </div>
    ...
    <div class="row">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title"><?php echo e(translate('Language')); ?></h3>
            </div>
            <div class="panel-body">
                                ...
                                <td>
                                    <div class="btn-group dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="<?php echo e(route('languages.show', encrypt($language->id))); ?>"><?php echo e(translate('Translation')); ?></a></li>
                                            <li><a href="<?php echo e(route('languages.edit', encrypt($language->id))); ?>"><?php echo e(translate('Edit')); ?></a></li>
                                            <?php if($language->code != 'en'): ?>
                                                <li><a onclick="confirm_modal('<?php echo e(route('languages.destroy', $language->id)); ?>');"><?php echo e(translate('Delete')); ?></a></li>
                                            <?php endif; ?>
                                        </ul>
                                    </div>
                                </td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u9037400/public_html/hs/resources/views/business_settings/languages/index.blade.php ENDPATH**/ ?>
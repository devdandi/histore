        ...
        <div class="container">
            <div class="row">
                    ...
                    <ul class="inline-links d-lg-inline-block d-flex justify-content-between">
                        <li class="dropdown" id="lang-change">
                            ...
                            <a href="" class="dropdown-toggle top-bar-item" data-toggle="dropdown">
                                <img src="<?php echo e(my_asset('frontend/images/placeholder.jpg')); ?>" height="11" data-src="<?php echo e(my_asset('frontend/images/icons/flags/'.$locale.'.png')); ?>" class="flag lazyload" alt="<?php echo e(\App\Language::where('code', $locale)->first()->name); ?>" height="11"><span class="language"><?php echo e(\App\Language::where('code', $locale)->first()->name); ?></span>
                            </a>
                            <ul class="dropdown-menu">
                                <?php $__currentLoopData = \App\Language::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="dropdown-item <?php if($locale == $language): ?> active <?php endif; ?>">
                                        <a href="#" data-flag="<?php echo e($language->code); ?>"><img src="<?php echo e(my_asset('frontend/images/placeholder.jpg')); ?>" data-src="<?php echo e(my_asset('frontend/images/icons/flags/'.$language->code.'.png')); ?>" class="flag lazyload" alt="<?php echo e($language->name); ?>" height="11"><span class="language"><?php echo e($language->name); ?></span></a>
                                    </li>
                ...
                <div class="col-5 text-right d-none d-lg-block">
                    ...
                    <?php if(Auth::id() !== null): ?>
                        <li>
                            <a  class="top-bar-item" href="#">Saldo : Rp. <?php echo e(number_format( Auth::user()->balance)); ?></a>    
                        </li>
                        <?php endif; ?>
						<li>
                            <a href="<?php echo e(route('resi.track')); ?>" class="top-bar-item"><?php echo e(translate('Track Resi')); ?></a>
                        </li>

                        <li>
                            <a href="<?php echo e(route('orders.track')); ?>" class="top-bar-item"><?php echo e(translate('Track Order')); ?></a>
                        </li>
                        <?php if(\App\Addon::where('unique_identifier', 'affiliate_system')->first() != null && \App\Addon::where('unique_identifier', 'affiliate_system')->first()->activated): ?>
                            <li>
                                <a href="<?php echo e(route('affiliate.apply')); ?>" class="top-bar-item"><?php echo e(translate('Be an affiliate partner')); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if(auth()->guard()->check()): ?>
                        <li>
                            <a href="<?php echo e(route('dashboard')); ?>" class="top-bar-item"><?php echo e(translate('My Panel')); ?></a>
                        </li>
                        <li>
                            <a onclick="return confirm(' <?php echo e(translate('Are you sure to logout ?')); ?>')" href="<?php echo e(route('logout')); ?>" class="top-bar-item"><?php echo e(translate('Logout')); ?></a>
                        </li>
                        <?php else: ?>
                        <li>
                ...
                <div class="side-menu-header ">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <div class="side-login px-3 pb-3">
                            ...
                            <?php if(Auth::id() !== null): ?>
                                <a href="#">Saldo : Rp. <?php echo e(number_format( Auth::user()->balance)); ?></a>
                            <?php endif; ?>
                        </div>
                    ...
                    <ul class="side-seller-menu">
                        <?php $__currentLoopData = \App\Category::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <a href="<?php echo e(route('products.category', $category->slug)); ?>" class="text-truncate">
                                <img class="cat-image lazyload" src="<?php echo e(my_asset('frontend/images/placeholder.jpg')); ?>" data-src="<?php echo e(my_asset($category->icon)); ?>" width="13" alt="<?php echo e(__($category->name)); ?>">
                        ...
                        <div class="d-flex">
                            ...
                            <a class="navbar-brand w-100" href="<?php echo e(route('home')); ?>">
                                ...
                                <?php if($generalsetting->logo != null): ?>
                                    <img src="<?php echo e(my_asset($generalsetting->logo)); ?>" alt="<?php echo e(env('APP_NAME')); ?>">
                                <?php else: ?>
                                    <img src="<?php echo e(my_asset('frontend/images/logo/logo.png')); ?>" alt="<?php echo e(env('APP_NAME')); ?>">
                                <?php endif; ?>
                            </a>
                            ...
                            <div class="search-box flex-grow-1 px-4">
                                <form action="<?php echo e(route('search')); ?>" method="GET">
                                    <div class="d-flex position-relative">
                                        ...
                                        <div class="w-100">
                                            <input type="text" aria-label="Search" id="search" name="q" class="w-100" placeholder="<?php echo e(translate('I am shopping for...')); ?>" autocomplete="off">
                                        </div>
                                ...
                                <div class="d-none d-lg-inline-block">
                                    <div class="nav-compare-box" id="compare">
                                        <a href="<?php echo e(route('compare')); ?>" class="nav-box-link">
                                            ...
                                            <span class="nav-box-text d-none d-xl-inline-block"><?php echo e(translate('Compare')); ?></span>
                                            <?php if(Session::has('compare')): ?>
                                ...
                                <div class="d-none d-lg-inline-block">
                                    <div class="nav-wishlist-box" id="wishlist">
                                        <a href="<?php echo e(route('wishlists.index')); ?>" class="nav-box-link">
                                            ...
                                            <span class="nav-box-text d-none d-xl-inline-block"><?php echo e(translate('Wishlist')); ?></span>
                                            <?php if(Auth::check()): ?>
                                ...
                                <div class="d-inline-block" data-hover="dropdown">
                                    <div class="nav-cart-box dropdown" id="cart_items">
                                        <a href="" class="nav-box-link" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            ...
                                            <span class="nav-box-text d-none d-xl-inline-block"><?php echo e(translate('Cart')); ?></span>
                                            <?php if(Session::has('cart')): ?>
                                                ...
                                                <div class="dropdown-cart px-0">
                                                    <?php if(Session::has('cart')): ?>
                                                        <?php if(count($cart = Session::get('cart')) > 0): ?>
                                                            <div class="dc-header">
                                                                <h3 class="heading heading-6 strong-700"><?php echo e(translate('Cart Items')); ?></h3>
                                                            </div>
                                                            ...
                                                            <div class="dc-item py-3">
                                                                <span class="subtotal-text"><?php echo e(translate('Subtotal')); ?></span>
                                                                ...
                                                                <ul class="inline-links inline-links--style-3">
                                                                    <li class="px-1">
                                                                        <a href="<?php echo e(route('cart')); ?>" class="link link--style-1 text-capitalize btn btn-base-1 px-3 py-1">
                                                                            <i class="la la-shopping-cart"></i> <?php echo e(translate('View cart')); ?>
                                                                    ...
                                                                    <li class="px-1">
                                                                        <a href="<?php echo e(route('checkout.shipping_info')); ?>" class="link link--style-1 text-capitalize btn btn-base-1 px-3 py-1 light-text">
                                                                            <i class="la la-mail-forward"></i> <?php echo e(translate('Checkout')); ?>
                                                        ...
                                                        <?php else: ?>
                                                            <div class="dc-header">
                                                                <h3 class="heading heading-6 strong-700"><?php echo e(translate('Your Cart is empty')); ?></h3>
                                                            </div>
                                                        <?php endif; ?>
                                                    <?php else: ?>
                                                        <div class="dc-header">
                    ...
                    <div class="col-lg-3 position-static">
                        <div class="category-sidebar" id="category-sidebar">
                            <div class="all-category">
                                ...
                                <a href="<?php echo e(route('categories.all')); ?>" class="d-inline-block"><?php echo e(translate('See All')); ?> ></a>
                            </div>
                            <ul class="categories">
...
<?php /**PATH C:\xampp\htdocs\updatehs\resources\views/frontend/inc/nav.blade.php ENDPATH**/ ?>